  ...
  return (
    <div className="flex items-center justify-center mt-5 border-b ">
      <p
        ...
        className={`${tasks.completed ? "tracking-widest font-bold flex  justify-end transition gap-2 translate-x-[-20px] fa-solid fa-check text-green-500 border-r " : "transition translate-x-[0]"} px-5 font-semibold text-zinc-100 cursor-pointer w-full whitespace-normal overflow-hidden py-2`}
      >
         {tasks.input}  
      </p>
