  ...
  return (
    <div className="flex items-center justify-center mt-5 border-b ">
      <p
        ...
        className={`${tasks.completed ? "text-emerald-500 font-bold fa-solid fa-check flex justify-between tracking-widest transition gap-2 translate-x-[-20px]  border-r " : "transition translate-x-[0]"} px-5 font-semibold text-zinc-100 cursor-pointer w-full whitespace-normal overflow-hidden py-2`}
      >
         {tasks.input}  
      </p>
